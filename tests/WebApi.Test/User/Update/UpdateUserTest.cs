...
{
    public class UpdateUserTest : LivroDeReceitasClassFixture
    {
        private readonly string METHOD = "user";
        private readonly Guid _userIdentifier;

        public UpdateUserTest(CustomWebApplicationFactory factory) : base(factory) => _userIdentifier = factory.GetUserIdentifier();
